...
```bash
# Recommended: Gemma 3 (9B - Google's latest)
ollama pull gemma3
...
|-------|------|-------|---------|----------|
| **gemma3** | 9B | Medium | Excellent | General purpose ⭐ |
| **llama3.2** | 7B | Medium | High | Meta's latest |
...
1. **Start with gemma3** - Google's latest, excellent quality
